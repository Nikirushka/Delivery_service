...
namespace Delivery_service
{
    public partial class Login : Form
    {
        ...
        private void LoginB_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            string query = $"SELECT * FROM [Delivery service user] WHERE Login=N'{LoginTB.Text}' ";
            ...
            {
                reader.Close();
                query = $"SELECT id FROM [Delivery service user] WHERE Login=N'{LoginTB.Text}' and Password=N'{PasswordTB.Text}'";
                cmd = new SqlCommand(query, connection);
                reader = cmd.ExecuteReader();
                if (reader.HasRows)
                {
